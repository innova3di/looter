...
public class Adcontrol : MonoBehaviour
{
    ...
    public string RewardVideoAd = "ca-app-pub-3940256099942544/1033173712";
	...
	public void Start()
	{
		...
		this.rewardBasedVideo.LoadAd(this.CreateAdRequest(), RewardVideoAd);
		}
    ...
    public void check()
    {
        ...
        {
            GameObject.Find("RewardVideo").SetActive(false);
        }
    }
